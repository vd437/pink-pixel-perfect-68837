...
const Login = () => {
  return (
    <div className="flex min-h-screen flex-col bg-background">
      {/* Main Content */}
      <div className="flex flex-1 flex-col items-center justify-center px-6 pb-20 pt-16">
        <div className="w-full max-w-md space-y-8">
          <h1 className="text-center text-4xl font-bold">Log in to TikTok</h1>
      ...
      <div className="px-6 pb-8 text-center">
        <p className="text-xs text-muted-foreground">
          ...
          <button className="font-semibold text-foreground underline">Privacy Policy</button> to learn how we collect, use, and share your data.
        </p>
