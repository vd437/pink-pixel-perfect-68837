...
const CountrySelector = () => {
  ...
  const handleCountrySelect = (country: typeof countries[0]) => {
    navigate('/phone-input', { 
      state: { 
        selectedCountry: { 
          name: country.name.substring(0, 2), 
          code: country.code 
        } 
      } 
    });
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex items-center border-b p-4">
        ...
        <h1 className="flex-1 text-center text-lg font-semibold pr-10">Select country/region</h1>
      </div>
              ...
              .map((letter) => (
                <div key={letter}>
                  <div 
                    ...
                    className="sticky top-0 bg-background py-2 text-sm font-semibold z-10"
                  >
                    {letter}
                  </div>
                  <div className="space-y-1">
                    {groupedCountries[letter].map((country) => (
                      <button
                        ...
                        className="flex w-full items-center justify-between py-3 text-left hover:bg-muted rounded-md px-2"
                      >
